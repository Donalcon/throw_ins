...
from engine.FKs.copa_FKs_pred_cleaner import simple_cleaner, stats_cols, cols_not_for_modelling
import pandas as pd
...
todays_urls = ['https://www.fotmob.com/en-GB/matches/canada-vs-argentina/1an224#4407872',
               'https://www.fotmob.com/en-GB/matches/spain-vs-france/1hsydl#4043983']
dfs = []
game_id = 2000
...
# # MAKE PREDICTIONS
throw_model = load('FKs_XGB_SMOTE_optuna.joblib')
