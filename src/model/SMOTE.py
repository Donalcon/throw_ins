...
# Load data
full_df = pd.read_csv("data/processed_master_throws_4.csv")
full_df = filter_teams(full_df, european_countries)
...
cols_not_for_modelling = [
    ...
    'avg_div_touches_in_opposition_box', 'total_tackles', 'rolling_avg_touches_in_opposition_box',
]
...
# Save the model
joblib.dump(final_model, 'throw_in_XGB_SMOTE_euro.joblib')
