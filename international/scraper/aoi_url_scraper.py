...
def scrape_international_urls():
    ...
    # Define the path to the file where URLs will be saved
    url_file_path = "./international/data/who_scored_urls/2024_Euros_grp_stg.txt"

    # Load existing URLs from the file into a set
    ...
    try:
        ...
        base_url = "https://www.whoscored.com/Regions/247/Tournaments/124/Seasons/9299/Stages/23157/Show/International-European-Championship-2024"
        driver.get(base_url)
